...
//int main() {
//	// Open the BMP file
//	std::ifstream bmpFile("treeline.bmp", std::ios::binary);
//
//	if (!bmpFile) {
...
//	int imageDataSize = bmpHeader.fileSize - bmpHeader.dataOffset;
//
...
//
//	int bytesPerRow = (bmpHeader.width * bmpHeader.bitsPerPixel + 31) / 32 * 4; // Bytes are aligned to 4 bytes (32 bits)
//	
